...
void P1906MOL_ExtendedDiffusion::transmit(double tt, double D, double ic, P1906MOL_Pos ip)
{
...
void P1906MOL_ExtendedDiffusion::clean_wavevector(double min_concentration, P1906MOL_Pos receiver, double time)
{
...
//! \todo wv is a growing list of waves, will need to remove waves that have reached equilibrium (or disseminated)
double P1906MOL_ExtendedDiffusion::receive(double rt, P1906MOL_Pos rp)
{
...
{
  P1906MOL_ExtendedDiffusionWave wave;
  P1906MOL_Pos receiver; //! receiver 3D position [nm] (x,y,z)
  P1906MOL_Pos transmitter; //! receiver 3D position [nm] (x,y,z)
