...
public:
  ...
  void prepare_transmission(double tt, double D, double ic, P1906MOL_Pos ip);
  //! trigger a release using last configures values
  void transmit(double tt);
  //! sample the wave at receiver and time
  double concentration_wave (P1906MOL_Pos receiver, double time);
