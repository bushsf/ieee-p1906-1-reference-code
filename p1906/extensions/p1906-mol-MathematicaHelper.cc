...
NS_LOG_COMPONENT_DEFINE ("P1906MOL_MathematicaHelper");

TypeId P1906MOL_MathematicaHelper::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_MathematicaHelper")
    .SetParent<Object> ();
  return tid;
}

P1906MOL_MathematicaHelper::P1906MOL_MathematicaHelper ()
{
