...
=== P1906MOL_VolSurface [extends P1906MOL_ExtendedField] ===
File: p1906-mol-vol-surface.cc
...
=== P1906MOL_MathematicaHelper [extends Object] ===
File: p1906-mol-MathematicaHelper.cc
This class writes data to be imported into Mathematica.

=== P1906MOL_MATLABHelper [extends Object] ===
File: p1906-mol-MATLABHelper.cc
This class writes data to be imported into MATLAB.

=== P1906MOL_Metrics [extends Object] ===
File: p1906-mol-metrics.cc
...
=== P1906MOL_ExtendedPerturbation [extends P1906Perturbation] ===
File: p1906-mol-extended-perturbation.cc
Required to extend the IEEE 1906 core reference model.

=== P1906MOL_ExtendedCommunicationInterface [extends P1906CommunicationInterface] ===
p1906-mol-extended-communication-interface.cc
Required to extend the IEEE 1906 core reference model.

=== P1906MOL_ExtendedReceiverCommunicationInterface [extends P1906ReceiverCommunicationInterface] ===
File: p1906-mol-extended-receiver-communication-interface.cc
Required to extend the IEEE 1906 core reference model.

=== P1906MOL_ExtendedTransmitterCommunicationInterface [extends P1906TransmitterCommunicationInterface] ===
File: p1906-mol-extended-transmitter-communication-interface.cc
Required to extend the IEEE 1906 core reference model.
...
== Quick Start ==
These are the general steps to get up and running quickly by showing a simple, example model. See P1906MOL_MicrotubulesField::unitTest methods in the file p1906-mol-field-microtubule.cc for more examples.
...
==== Sample Code ====
  ...
  P1906MOL_Pos v_c;
  v_c.setPos (500, 0, 0);
  motor->addVolumeSurface(v_c, 100, P1906MOL_VolSurface::FluxMeter);
...
Another important point to keep in mind is that because motion is random, it may take a *very* long time to reach the destination. The P1906MOL_VolSurface::ReflectiveBarrier can help with  this by bounding the space within which the motor can move.
