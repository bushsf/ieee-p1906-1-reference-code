...
NS_LOG_COMPONENT_DEFINE ("P1906MOL_MATLABHelper");

TypeId P1906MOL_MATLABHelper::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_MATLABHelper")
    .SetParent<Object> ();
  return tid;
}

P1906MOL_MATLABHelper::P1906MOL_MATLABHelper ()
{
