...
NS_LOG_COMPONENT_DEFINE ("P1906MOL_ExtendedReceiverCommunicationInterface");

TypeId P1906MOL_ExtendedReceiverCommunicationInterface::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_ExtendedReceiverCommunicationInterface")
    .SetParent<P1906ReceiverCommunicationInterface> ();
  return tid;
}

P1906MOL_ExtendedReceiverCommunicationInterface::P1906MOL_ExtendedReceiverCommunicationInterface ()
{
...
void
P1906MOL_ExtendedReceiverCommunicationInterface::HandleReception (Ptr<P1906CommunicationInterface> src, Ptr<P1906CommunicationInterface> dst, Ptr<P1906MessageCarrier> message)
{
  NS_LOG_FUNCTION (this);
