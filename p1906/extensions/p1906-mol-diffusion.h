...
public:
  ...
  void transmit(double tt, double D, double ic, P1906MOL_Pos ip);
  void clean_wavevector(double min_concentration, P1906MOL_Pos receiver, double time);
  double receive(double rt, P1906MOL_Pos rp);
