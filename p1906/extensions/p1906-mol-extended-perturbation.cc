...
NS_LOG_COMPONENT_DEFINE ("P1906MOL_ExtendedPerturbation");

TypeId P1906MOL_ExtendedPerturbation::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_ExtendedPerturbation")
    .SetParent<P1906Perturbation> ();
  return tid;
}

P1906MOL_ExtendedPerturbation::P1906MOL_ExtendedPerturbation ()
{
...
void
P1906MOL_ExtendedPerturbation::SetPulseInterval (Time t)
{
...
Time
P1906MOL_ExtendedPerturbation::GetPulseInterval (void)
{
  NS_LOG_FUNCTION (this);
...
void
P1906MOL_ExtendedPerturbation::SetMolecules (double q)
{
...
double
P1906MOL_ExtendedPerturbation::GetMolecules (void)
{
  NS_LOG_FUNCTION (this);
  return m_molecules;
}
...
P1906MOL_ExtendedPerturbation::CreateMessageCarrier (Ptr<Packet> p)
{
  NS_LOG_FUNCTION (this);
