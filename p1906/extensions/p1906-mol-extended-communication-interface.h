...
class P1906MOL_ExtendedCommunicationInterface : public P1906CommunicationInterface
{
public:
  static TypeId GetTypeId (void);

  P1906MOL_ExtendedCommunicationInterface ();
  virtual ~P1906MOL_ExtendedCommunicationInterface ();
