...
#include "p1906-mol-metrics.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("P1906MOL_Metrics");

TypeId P1906MOL_Metrics::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_Metrics")
    .SetParent<Object> ();
  return tid;
}

P1906MOL_Metrics::P1906MOL_Metrics ()
{
...
void P1906MOL_Metrics::Bandwidth_Delay_Product()
{}
...
void P1906MOL_Metrics::Information_and_Communication_Energy()
{}
...
void P1906MOL_Metrics::Bandwidth_Volume_Ratio()
{}
