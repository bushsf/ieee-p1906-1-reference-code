...
#ifndef P1906_MOL_EXTENDED_RECEIVER_COMMUNICATION_INTERFACE
#define P1906_MOL_EXTENDED_RECEIVER_COMMUNICATION_INTERFACE
 ...
 *
 * \class P1906MOL_ExtendedReceiverCommunicationInterface
 *
 * \brief Base class implementing a the Receiver entity
 * of the P1906 framework for the MOLECULAR Example
 */

class P1906MOL_ExtendedReceiverCommunicationInterface : public P1906ReceiverCommunicationInterface
{
public:
  static TypeId GetTypeId (void);

  P1906MOL_ExtendedReceiverCommunicationInterface ();
  virtual ~P1906MOL_ExtendedReceiverCommunicationInterface();
...
#endif /* P1906_MOL_EXTENDED_RECEIVER_COMMUNICATION_INTERFACE */
