...
void P1906MOL_ExtendedDiffusionWave::prepare_transmission(double tt, double Cd, double ic, P1906MOL_Pos ip)
{
...
double P1906MOL_ExtendedDiffusionWave::concentration_wave (P1906MOL_Pos receiver, double time)
{
