...
NS_LOG_COMPONENT_DEFINE ("P1906MOL_VolSurface");

TypeId P1906MOL_VolSurface::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_VolSurface")
    .SetParent<P1906MOL_ExtendedField> ();
  return tid;
}

P1906MOL_VolSurface::P1906MOL_VolSurface ()
{
...
void P1906MOL_VolSurface::displayVolSurface()
{
...
void P1906MOL_VolSurface::setType (typeOfVolume st)
{
  volType = st;
}

//! get the type, which can be FluxMeter, ReflectiveBarrier, Receiver
P1906MOL_VolSurface::typeOfVolume P1906MOL_VolSurface::getType ()
{
  return volType;
}
...
* </pre>
*/
void P1906MOL_VolSurface::reflect(P1906MOL_Pos last_pos, P1906MOL_Pos & current_pos)
{
  vector<P1906MOL_Pos> intersection;
...
void P1906MOL_VolSurface::getRadiusLine(gsl_vector * v_radius, P1906MOL_Pos pt)
{  
  line (v_radius, center, pt);
}

//! return the angle between two vectors
double P1906MOL_VolSurface::vectorAngle(gsl_vector * seg1, gsl_vector * seg2)
{
...
double P1906MOL_VolSurface::fluxMeter(gsl_matrix * tubeMatrix)
{
  //! the total flux
  double flux = 0;
  //! all intersection points
  vector<P1906MOL_Pos> ipts;
  //! the current segment
...
bool P1906MOL_VolSurface::isInsideVolSurf(P1906MOL_Pos pt)
{
  bool isInside = false;
  double norm = 0;
...
void P1906MOL_VolSurface::sphereIntersections(gsl_vector * segment, vector<P1906MOL_Pos> & ipt)
{
  P1906MOL_Pos o, l, c;
  double d, r;
  ...
  //! see int P1906MOL_ExtendedField::getOverlap3D(gsl_vector * segment, gsl_matrix * tubeMatrix, gsl_matrix * pts, gsl_vector * tubeSegments)
