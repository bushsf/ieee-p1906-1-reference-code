...
NS_LOG_COMPONENT_DEFINE ("P1906MOL_ExtendedField");

TypeId P1906MOL_ExtendedField::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::P1906MOL_ExtendedField")
    .SetParent<P1906MOLField> ();
  return tid;
}

P1906MOL_ExtendedField::P1906MOL_ExtendedField ()
{
...
bool P1906MOL_ExtendedField::isPointOverlap(gsl_vector * pt, gsl_vector * segment)
{
	bool overlap = false;
	/**
...
double P1906MOL_ExtendedField::distance(gsl_vector *pt, gsl_vector *segment_or_point)
{
...
void P1906MOL_ExtendedField::getAllOverlaps3D(gsl_matrix *tubeMatrix, vector<P1906MOL_Pos> & pts)
{
